...
//Game sounds
var rightGuessSound = new Audio("./assets/sounds/hit.wav");
var wrongGuessSound = new Audio("./assets/sounds/strike.wav");
var winSound = new Audio("./assets/sounds/cheer.wav");
var loseSound = new Audio("./assets/sounds/Out.wav");
...
function roundComplete() {
  ...
  //avoid checking for spaces in win condition
  let blanksAndCorrectWithoutSpaces = blanksAndCorrect.filter(
    item => item !== "&nbsp;"
  );
  let lettersInWordWithoutSpaces = lettersInWord.filter(item => item !== " ");

  console.log(
    "liw: " +
      lettersInWord.toString() +
      " bac: " +
      blanksAndCorrectWithoutSpaces.toString()
  );
  if (
    lettersInWordWithoutSpaces.toString() ===
    blanksAndCorrectWithoutSpaces.toString()
  ) {
